...
const TRANSLATIONS = {
    english: {
        ...
        prayerAlertInfo: "Fajr rings for 5 minutes. Other prayer alerts show for 10 seconds with a light vibration. To make Fajr ring, turn off Do Not Disturb and Sleep Mode on your watch.",
        fajrSystemModeWarning: "Fajr alarm blocked.\nPlease turn off Sleep Mode and Do Not Disturb in watch system settings.",
        testFajrAlarm: "Test Fajr Alarm",
        testAlarmScheduled: "Starting alarm…",
        testPrayerNotification: "Test Notification",
        testNotificationScheduled: "Sending notification…",
        am: "AM",
        pm: "PM",
    ...
    farsi: {
        ...
        prayerAlertInfo: "زنگ نماز صبح ۵ دقیقه ادامه دارد. هشدارهای نمازهای دیگر ۱۰ ثانیه با لرزش سبک نمایش داده می‌شوند. برای زنگ خوردن نماز صبح، حالت »مزاحم نشوید« و »حالت خواب« را در ساعت خود خاموش کنید.",
        fajrSystemModeWarning: "برای فعال شدن زنگ نماز صبح، حالت »مزاحم نشوید« و »خواب« را در تنظیمات ساعت غیر فعال کنید.",
        testFajrAlarm: "آزمایش هشدار صبح",
        testAlarmScheduled: "در حال اجرای هشدار…",
        testPrayerNotification: "آزمایش اعلان",
        testNotificationScheduled: "در حال ارسال اعلان…",
        am: "ق.ظ",
        pm: "ب.ظ",
        ...
        qiblaCalibrate: "برای کالیبره کردن قطب‌نما، مچ خود را به شکل ∞ حرکت دهید",
    ...
    arabic: {
        ...
        prayerAlertInfo: "يرن تنبيه الفجر لمدة ٥ دقائق. تظهر تنبيهات الصلوات الأخرى لمدة ١٠ ثوانٍ مع اهتزاز خفيف. لكي يرن الفجر، أوقف وضع »عدم الإزعاج« و»وضع النوم« في ساعتك.",
        fajrSystemModeWarning: "لتفعيل رنين صلاة الفجر، أوقف وضع »عدم الإزعاج« و»النوم« من إعدادات الساعة.",
        testFajrAlarm: "اختبار منبّه الفجر",
        testAlarmScheduled: "جارٍ تشغيل المنبّه…",
        testPrayerNotification: "اختبار الإشعار",
        testNotificationScheduled: "جارٍ إرسال الإشعار…",
        am: "ص",
        pm: "م",
        ...
        qiblaCalibrate: "حرّك معصمك على شكل ∞ لمعايرة البوصلة",
