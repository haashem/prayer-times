...
const TRANSLATIONS = {
    english: {
        ...
        fajrAlarmSound: "Fajr Alarm Sound",
        prayerAlertInfo: "Fajr uses an alarm; other prayers use standard notifications.",
        am: "AM",
        pm: "PM",
    ...
    farsi: {
        ...
        fajrAlarmSound: "صدای زنگ نماز صبح",
        prayerAlertInfo: "نماز صبح با زنگ اعلام می‌شود؛ سایر نمازها با اعلان معمولی.",
        am: "ق.ظ",
        pm: "ب.ظ",
    ...
    arabic: {
        ...
        fajrAlarmSound: "صوت منبّه الفجر",
        prayerAlertInfo: "يُعلَن عن صلاة الفجر بمنبّه، بينما يُعلَن عن بقية الصلوات بإشعارات عادية.",
        am: "ص",
        pm: "م",
