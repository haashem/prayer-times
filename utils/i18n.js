...
const TRANSLATIONS = {
    english: {
        ...
        prayerAlertInfo: "Fajr uses alarm. Turn off Do Not Disturb and Sleep Mode so it can ring.",
    ...
    farsi: {
        ...
        prayerAlertInfo: "برای فجر از زنگ استفاده می شود. برای زنگ خوردن از تنظیمات ساعت گزینه‌های زیر را غیر فعال کنید:\nDo Not Disturb, Sleep Mode",
    ...
    arabic: {
        ...
        prayerAlertInfo: "يُستخدم الرنين للفجر. لكي يرن، عطّل الخيارات التالية من إعدادات الساعة:\nDo Not Disturb, Sleep Mode",
