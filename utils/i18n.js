...
const TRANSLATIONS = {
    ...
    farsi: {
        ...
        prayerAlertInfo: "فجر از هشدار استفاده می‌کند؛ نمازهای دیگر از اعلان معمولی استفاده می‌کنند.",
    ...
    arabic: {
        ...
        prayerAlertInfo: "الفجر يستخدم المنبّه، وبقية الصلوات تستخدم إشعارات عادية.",
