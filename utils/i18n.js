...
const TRANSLATIONS = {
    english: {
        ...
        prayerAlertInfo: "Fajr uses alarm, other prayers use standard notifications.",
    ...
    farsi: {
        ...
        prayerAlertInfo: "برای فجر از زنگ استفاده می‌شود؛ نمازهای دیگر با اعلان معمولی اعلام می‌شوند.",
        fajrSystemModeWarning: "هشدار فجر مسدود است.\nلطفاً حالت خواب و مزاحم نشوید را در تنظیمات سیستم ساعت خاموش کنید.",
        am: "ق.ظ",
        pm: "ب.ظ",
    ...
    arabic: {
        ...
        prayerAlertInfo: "يُستخدم الرنين للفجر؛ وتُعلَن بقية الصلوات بإشعارات عادية.",
        fajrSystemModeWarning: "منبّه الفجر محظور.\nيرجى إيقاف وضع النوم وعدم الإزعاج من إعدادات نظام الساعة.",
        am: "ص",
        pm: "م",
