...
const TRANSLATIONS = {
    english: {
        ...
        prayerAlertInfo: "To hear Fajr alarm sound, enable Ring for Alert in watch Settings > Sound & Vibration. Other prayers use standard notifications.",
        am: "AM",
        pm: "PM",
    ...
    farsi: {
        ...
        prayerAlertInfo: "برای شنیدن صدای زنگ نماز صبح، زنگ اعلان‌ها را در بخش صدا و لرزش تنظیمات ساعت روشن کنید. سایر نمازها با اعلان معمولی اعلام می‌شوند.",
        am: "ق.ظ",
        pm: "ب.ظ",
    ...
    arabic: {
        ...
        prayerAlertInfo: "لسماع صوت رنين صلاة الفجر، فعّل رنين الإشعارات من قسم الصوت والاهتزاز في إعدادات الساعة. بقية الصلوات تستخدم إشعارات عادية.",
        am: "ص",
        pm: "م",
