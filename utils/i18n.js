...
const TRANSLATIONS = {
    ...
    farsi: {
        ...
        prayerAlertInfo: "نماز صبح از هشدار استفاده می‌کند؛ سایر نمازها اعلان عادی دریافت می‌کنند.",
        am: "ق.ظ",
        pm: "ب.ظ",
    ...
    arabic: {
        ...
        prayerAlertInfo: "يستخدم الفجر منبّهًا، بينما تستخدم بقية الصلوات إشعارات عادية.",
        am: "ص",
        pm: "م",
