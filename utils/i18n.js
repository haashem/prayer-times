...
const TRANSLATIONS = {
    english: {
        ...
        timeForPrayer: "Time for",
        prayerAlertInfo: "Fajr uses an alarm, and the other prayers use notifications. To make Fajr ring, turn off Do Not Disturb and Sleep Mode on your watch.",
    ...
    farsi: {
        ...
        timeForPrayer: "نماز",
        prayerAlertInfo: "برای اذان صبح از زنگ استفاده می‌شود و برای بقیه نمازها اعلان ارسال می‌شود. برای زنگ خوردن اذان صبح، حالت »مزاحم نشوید« و »حالت خواب« را در ساعت خود خاموش کنید.",
    ...
    arabic: {
        ...
        timeForPrayer: "الصلاة",
        prayerAlertInfo: "يُستخدم الرنين لأذان الفجر، وتُرسل إشعارات لبقية الصلوات. لكي يرن أذان الفجر، أوقف وضع »عدم الإزعاج« و»وضع النوم« في ساعتك.",
