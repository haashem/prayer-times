...
const TRANSLATIONS = {
    english: {
        ...
        prayerNotificationContent: "{prayer} time has begun in {city}.",
        openApp: "Open",
    ...
    farsi: {
        ...
        prayerNotificationTitle: "وقت نماز",
        prayerNotificationContent: "وقت {prayer} در {city} فرا رسیده است.",
        openApp: "باز کردن",
    ...
    arabic: {
        ...
        prayerNotificationTitle: "وقت الصلاة",
        prayerNotificationContent: "حان وقت {prayer} في {city}.",
        openApp: "فتح",
        yourLocation: "موقعك",
