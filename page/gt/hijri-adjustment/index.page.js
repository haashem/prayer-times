    ...
    BasePage({
        ...
        onInit(params) {
            try {
                ...
                this.state.hijriDate = data && data.hijriDate;
            } catch (e) {
        ...
        build() {
            ...
            this.state.previewWidget = createWidget(widget.TEXT, {
                ...PREVIEW_STYLE,
                text: formatHijriDate(this.state.hijriDate) || t("noDataToday"),
            });
            this.renderOptions();
        ...
        renderOptions() {
            ...
            for (let i = 0; i < HIJRI_OPTIONS.length; i++) {
                this.renderOptionRow(HIJRI_OPTIONS[i], i);
            }
            ...
            onKey({
                callback: (key, keyEvent) => {
                    ...
                    if (isCrownKey && keyEvent === KEY_EVENT_CLICK) {
                        if (this.state.focusIndex < HIJRI_OPTIONS.length) {
